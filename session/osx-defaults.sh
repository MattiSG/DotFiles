...
# Don't insert a period on double space
...
# Require password 15 mins after sleep or screen saver begins
...
open "`dirname $BASH_SOURCE`/../Library/Terminal Settings/Matti.terminal"
sleep 1 # Wait a bit to make sure the theme is loaded
defaults write com.apple.Terminal "Default Window Settings" -string "Matti"
defaults write com.apple.Terminal "Startup Window Settings" -string "Matti"
...
defaults write org.m0k.transmission IncompleteDownloadFolder -string "${HOME}/BitTorrent"
...
echo "Done. Note that these changes will be applied after modified applications are restarted, and some require a logout to take effect."
